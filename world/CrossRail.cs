...
{
    public class CrossRail : Rail
    {

        public static Texture2D RailTexture;

        public CrossRail(Direction orientation, bool deletable) : base(orientation, deletable)
        {
        }

        public override Tuple<Direction, Direction>[] GetPaths()
        {
            return new Tuple<Direction, Direction>[] { new Tuple<Direction, Direction>(Direction.North, Direction.North), new Tuple<Direction, Direction>(Direction.East, Direction.East), new Tuple<Direction, Direction>(Direction.South, Direction.South), new Tuple<Direction, Direction>(Direction.West, Direction.West) };
        }
